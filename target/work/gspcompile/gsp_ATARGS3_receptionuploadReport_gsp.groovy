...
createTagBody(1, {->
printHtmlPart(8)
invokeTag('remoteField','g',65,['name':("A"),'action':("Afunc"),'update':("PatientTable")],-1)
printHtmlPart(9)
invokeTag('remoteField','g',67,['name':("FN"),'action':("FNfunc"),'update':("PatientTable")],-1)
printHtmlPart(9)
invokeTag('remoteField','g',69,['name':("LN"),'action':("LNfunc"),'update':("PatientTable")],-1)
printHtmlPart(9)
invokeTag('remoteField','g',71,['name':("M"),'action':("Mfunc"),'update':("PatientTable")],-1)
printHtmlPart(9)
invokeTag('remoteField','g',73,['name':("MOB"),'action':("MOBfunc"),'update':("PatientTable")],-1)
printHtmlPart(10)
for( _it16118200 in (uploadReports) ) {
changeItVariable(_it16118200)
printHtmlPart(11)
...
invokeTag('link','g',101,['params':([p:it.id]),'action':("selectFile")],4)
printHtmlPart(16)
})
invokeTag('form','g',104,['action':("selectFile"),'method':("post")],3)
printHtmlPart(17)
}
printHtmlPart(18)
})
...
public static final long LAST_MODIFIED = 1394306917000L
