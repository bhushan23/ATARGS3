...
class gsp_ATARGS3_documentcreate_gsp extends GroovyPage {
...
printHtmlPart(12)
expressionOut.print(patient?.summary)
printHtmlPart(13)
invokeTag('submitButton','g',33,['name':("upload"),'class':("custombutton"),'value':("Upload")],-1)
printHtmlPart(14)
})
invokeTag('uploadForm','g',35,['action':("upload")],2)
printHtmlPart(15)
})
