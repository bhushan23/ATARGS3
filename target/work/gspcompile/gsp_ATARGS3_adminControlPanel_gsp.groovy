...
printHtmlPart(12)
expressionOut.print(createLink(uri: '/admin/uploadReport'))
printHtmlPart(13)
...
createTagBody(2, {->
printHtmlPart(16)
for( _it28674518 in (0..23) ) {
changeItVariable(_it28674518)
printHtmlPart(17)
...
printHtmlPart(22)
for( _it23885784 in (0..23) ) {
changeItVariable(_it23885784)
printHtmlPart(17)
expressionOut.print(it)
printHtmlPart(18)
expressionOut.print(it)
...
public static final long LAST_MODIFIED = 1394304036000L
