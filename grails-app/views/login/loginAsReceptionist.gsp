...
<body>
	...
	-->
		...
		<g:else>
			...
			<g:form action="receptionist_login_function" method="post"
				class="form-signin">
				<div class="input">
					<br />
					<legend>
					...
					<table class="userForm">
						<tr class='prop'>
							...
							<td valign='top' style='text-align: left;' width='80%'><input
								...
								class="input-block-level" value='${receptionlogin?.username}' /></td>
						</tr>
						<tr class='prop'>
							...
							<td valign='top' style='text-align: left;' width='80%'><input
								...
								class="input-block-level" value='${receptionlogin?.password}' /></td>
						</tr>
					</table>
				</div>

				<div class="buttons">
					<span class="formButton"> <input type="submit" value="Login"
						class="btn btn-large btn-info"></input> <g:link controller="login"
							action="SignupAsReceptionist" class="btn btn-large btn-success">Sign up </g:link>
					</span>
				</div>
			</g:form>
		</g:else>
