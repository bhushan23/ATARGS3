							...
							<g:each in="${req_entry }">
								<tr>
									...
									<td><input type="text" name="firstname" size="40"
										value="${it.firstname }" /></td>
								</tr>
								<tr>

									<td>Middle Name</td>
									<td><input type="text" name="middlename" size="40"
										value="${it.middlename }" /></td>
								</tr>
								<tr>
									<td>Last Name</td>
									<td><input type="text" name="lastname" size="40"
										value="${it.lastname }" /></td>
								</tr>
								<tr>
									<td>Gender</td>
								...
								<tr>
									<td>Age</td>
									<td><input type="text" name="age" size="40"
										value="${it.age }" /></td>
								</tr>
								<tr>
									<td>Mobile No.</td>
								...
								<tr>
									<td>Pincode</td>
									<td><input type="text" name="pincode" size="40"
										value="${it.pincode }"></td>
								</tr>
								<tr>
									<td>City</td>
								...
								<tr>
									...
									<td><textarea name="history" rows="4" cols="40" style="width: 25%">${it.clinicalhistory }</textarea></td>
								...
								<tr>
									...
									<input type="submit" value="Done"
										class="btn btn-large btn-success" /></td>
