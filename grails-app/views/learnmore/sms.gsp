...
<div class="hero-unit">
 <legend> <h1>  Appointment By SMS</h1></legend>
      ...
      <div class="row featurette">
        ...
        <div class="col-md-9">
          <h2 class="featurette-heading">Available Appointment of a day<br><span class="text-muted"><br>ATARG 2014-01-25 CT</span></h2>
          <p class="lead"> Above example search and suggests available appointments of <b>CT machine for 25th January 2014 </b><br><br>Type <b>ATARG YYYY-MM-DD MACHINE{MRI OR CT}</b> and send SMS to 56263456</p>
        </div>
        <div class="col-md-3">
...
<hr class="featurette-divider">
      ...
      <div class="row featurette">
        ...
        <div class="col-md-9">
          <h2 class="featurette-heading">Confirm Appointment by SMS<br><span class="text-muted">Reply Accordingly<br> ATARG 1 <br>ATARG 2<br>ATARG 3</span></h2>
      ...
      <div class="row featurette">
        ...
        <div class="col-md-9">
          <h2 class="featurette-heading">Cancel Appointments<span class="text-muted"><br>ATARG CAN</span></h2>
          <p class="lead">Cancel Your Appointment By Messaging ATARG CAN</p>
        </div>
      </div>
      <hr class="featurette-divider">
