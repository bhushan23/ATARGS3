...
class SendsmsController {
	...
	def index() {
		 ...
		 /*SMSLANE*/
		 String user,password,msisdn,msg,sid,fl
		 user="abcd1"
		 password="662239"
		 msg="!!!Hey its bs. SMS sending via app works!!!"
		 msisdn="918983062202"
		 sid="WebSMS"
		 fl="0"
	...
	/*def smsuser=AdminSettings.findWhere(entry:"smsUser")
		user =String.valueOf(smsuser['value'])
		 smsuser=AdminSettings.findWhere(entry:"smsPass")
		 password=String.valueOf(smsuser['value'])
	*/
