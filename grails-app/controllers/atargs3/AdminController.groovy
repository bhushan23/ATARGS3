...
def notifymanually()
{
	...
	def saveChanges() {
		...
		db.execute("UPDATE admin_settings SET value='${params["smsservice"]}' WHERE entry='usesmsservice'")
		db.execute("UPDATE admin_settings SET value='${params["emailservice"]}' WHERE entry='useemailservice'")
